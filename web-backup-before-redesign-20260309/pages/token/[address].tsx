  ...
  return (
    <>
      ...
      <div style={{...cardStyle, marginTop:20}}>
        <div style={labelStyle}>DEX Market</div>
        ...
        <div style={{display:"flex",gap:10,marginTop:14,flexWrap:"wrap"}}>
          <a href="/swap" style={{padding:"8px 12px",border:"1px solid rgba(255,255,255,0.15)",borderRadius:8,textDecoration:"none"}}>
            Swap
          </a>

          <a href="/liquidity" style={{padding:"8px 12px",border:"1px solid rgba(255,255,255,0.15)",borderRadius:8,textDecoration:"none"}}>
            Add Liquidity
          </a>

          <a href="/pools" style={{padding:"8px 12px",border:"1px solid rgba(255,255,255,0.15)",borderRadius:8,textDecoration:"none"}}>
            Pools
          </a>
        </div>
      </div>
...
<a href={`/token/${tokenAddress}/holders`} style={{textDecoration:"none",fontWeight:700}}>
View Holders →
</a>
</div>
